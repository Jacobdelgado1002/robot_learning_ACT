...
This is a repository created by Jacob Delgado Lopez and Laura Fleig of the ARCADE lab at The Johns Hopkins University. It builds off of the original SRTH work, also conducted at JHU.
...
```bash
conda create -n robot_learning python=3.10
...
Sometimes pip will give you a warning that the dependencies are not met, but you can ignore it. Other times, it will be an issue. We recommend installing the below pinned versions.
